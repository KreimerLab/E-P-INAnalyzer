...
#SBATCH --requeue 
#SBATCH --job-name=Enhancer-Interactions-Project
#SBATCH --nodes=1
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=32
#SBATCH --mem=192000
#SBATCH --time=10:00:00
#SBATCH --output=/home/wbd20/Kreimer_Lab/Logs/Enhancer-Interactions.%N.%j.olog
#SBTACH --error=/home/wbd20/Kreimer_Lab/Logs/Enhancer-Interactions.%N.%j.elog
