...
library(DESeq2)
library(tidyverse)
source('/E-P-INs/Scripts/DESeq2/DESeq2.R')

# DESeq2 Analysis
DESeq2(comparisons = '0hrs_3hrs.ATACSeq',
       comparisons_dir = '/E-P-INs/ATACSeq/DESeq2/Comparisons/',
       conditions = c('0hrs.ATACSeq', '3hrs.ATACSeq'),
       conditions_dir = '/E-P-INs/ATACSeq/DESeq2/Conditions/',
       results_dir = '/E-P-INs/ATACSeq/DESeq2/Results/',
       padj_threshold = 0.05)
